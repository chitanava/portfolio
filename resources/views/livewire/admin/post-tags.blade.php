            ...
            <div class="form-control space-y-3">
                ...
                <div>
                    ...
                    <div class="badge badge-success gap-2">
                        <svg wire:key="badge-{{ $loop->iteration }}" wire:click="removeTag('{{ $tag['name'] }}')" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                ...
                <input 
                    ...
                    wire:keydown.space.prevent="addTag($event.target.value)" 
                    wire:model="inputTag"
                    type="text"
